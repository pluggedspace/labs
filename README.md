...
Pluggedspace Labs is the experimental research division of Pluggedspace.

This space exists to explore applied systems in AI, automation, fintech, governance, and security.

Projects in Labs are exploratory by design. They test ideas, validate architectures, and investigate domain-specific intelligence applications.

They are not part of the core **Akili Enterprise Intelligence Platform** unless explicitly stated.
...
## Relationship to Akili

Akili is Pluggedspace’s enterprise intelligence platform.
...
External contributors are welcome to explore, test, and extend Labs projects.

Contributions to core infrastructure are managed separately.
